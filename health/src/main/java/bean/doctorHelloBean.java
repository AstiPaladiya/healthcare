...
import client.secureDoctorClient;
 ...
 * @author palad
 */
@Named(value = "doctorHelloBean")
@RequestScoped
public class doctorHelloBean {
 secureDoctorClient cl;
    String secureHello;
    String message="";
