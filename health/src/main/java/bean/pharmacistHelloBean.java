...
import client.securePharmacistClient;
 ...
 * @author palad
 */
@Named(value = "pharmacistHelloBean")
@RequestScoped
public class pharmacistHelloBean {

    securePharmacistClient cl;
    String secureHello;
    String message = "";
